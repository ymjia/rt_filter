#ifndef SN3D_GRAPHICS_RIGID_MATRIX_H
#define SN3D_GRAPHICS_RIGID_MATRIX_H
...
namespace Sn3DAlgorithm
{
	...
	inline RigidMatrix::RigidMatrix(const Eigen::Matrix3d &rot, const Eigen::Vector3d &vec)
		: _rot(rot), _trans(vec)
	{
	}
...
#endif // SN3D_GRAPHICS_RIGID_MATRIX_H
